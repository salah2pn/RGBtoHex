...
function toHex(){
    ...
    let rgbRegax1 = /^rgb\([0-9]{1,3},[0-9]{1,3},[0-9]{1,3}\)$/;
    let rgbRegax2 = /^[0-9]{1,3},[0-9]{1,3},[0-9]{1,3}$/
    let hex = "#";
    if(rgbRegax1.test(rgbCode) || rgbRegax2.test(rgbCode)){
